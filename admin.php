            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <?php
                            if($_SESSION['admin'] == 1){
                                echo "<strong>admin</strong>. Anda memiliki akses penuh .";
                            } elseif($_SESSION['admin'] == 2){
                                echo "<strong>Administrator</strong>. Berikut adalah statistik yang tersimpan.";
                            } else {
                                echo "<strong>Petugas Disposisi</strong>. Berikut adalah statistik data yang tersimpan .";
                            }?></p>
                    </div>
                </div>
            </div>

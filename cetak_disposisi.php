        ...
        <div class="container">
            <div id="colres">
                <div class="disp">';
                    ...
                    if(!empty($institusi)){
                        ...
                        echo '<h6 class="up"> Cikidang </h6>' ;
                    if(!empty($nama)){
                        echo '<h5 class="up" id="nama">'.$nama.'</h5><br/>';
                    } else {
                        echo '<h5 class="up" id="nama"> Jenal aripin s.ip </h5><br/>';
                    }
                    if(!empty($status)){
                        echo '<h6 class="status">'.$status.'</h6>';
                    } else {
                        echo '<h6 class="status"> KEPALA DESA </h6>';
                    }
                    if(!empty($alamat)){
                        echo '<span id="alamat">'.$alamat.'</span>';
                    } else {
                        echo '<span id="alamat"> JL TUNGTURUNAN NO.65 KECAMATAN MANDE KAB.CIANJUR</span>';
                    }
                    echo '
                </div>
            ...
            <div id="lead">
                ...
                if(!empty($kepsek)){
                    ...
                    echo '<p class="lead">Pak JENAL ARIPIN.</p>';
                }
                if(!empty($nip)){
                    echo '<p>NIP. '.$nip.'</p>';
                } else {

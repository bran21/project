            ...
            $pg = @$_GET['pg'];
                ...
                echo '
                    ...
                    <div class="row jarak-form">
                                    ...
                                    if($_SESSION['username'] == $row['username']){
                                        ...
                                        if($row['id_user'] == 1){
                                          ...
                                          echo ' <a class="btn small blue waves-effect waves-light" href="?page=sett&sub=usr&act=edit&id_user='.$row['id_user'].'">
                                                 ...
                                                 <a class="btn small deep-blue waves-effect waves-light" href="?page=sett&sub=usr&act=del&id_user='.$row['id_user'].'"><i class="material-icons">delete</i> DEL</a>';
                                        }
                                    } echo '</td>
                                    </tr>
                                </tbody>';
                        ...
                        echo '<tr><td colspan="5"><center><p class="add">data is not available</p></center></td></tr>';
                                }
                      echo '</table>
                            <!-- Table END -->
                        </div>
                    ...
                    if($cdata > $limit){
                        ...
                        if($pg < $cpg){
                            $next = $pg + 1;
                            echo '<li><a href="?page=sett&sub=usr&pg='.$next.'"><i class="material-icons md-48">chevron_left</i></a></li>
                                  <li><a href="?page=sett&sub=usr&pg='.$cpg.'"><i class="material-icons md-48">last_page</i></a></li>';
                        } else {
                            echo '<li class="disabled"><a href=""><i class="material-icons md-48">chevron_left</i></a></li>

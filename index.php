                        ...
                        <div class="card-content">
                            ...
                            <?php
                                if(!empty($data['nama'])){
                                    ...
                                    echo 'SMK NURUL ISLAM AFFANDIYAH'; 
                                }
                             ?>
                            </h4>
                            <div class="batas"></div>
                    ...
                    <?php
                        if(isset($_REQUEST['submit'])){
                            ...
                            if($_REQUEST['username'] == "" || $_REQUEST['password'] == ""){
                                ...
                                $query = mysqli_query($config, "SELECT id_user, username, nama, nip, admin FROM tbl_user WHERE username=BINARY'$username' AND password=BINARY('$password')");
